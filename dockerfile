...
RUN sdkmanager --install "platform-tools" "platforms;android-30" "system-images;android-30;default;armeabi-v7a" "emulator"

# Create Android Virtual Device (AVD)
RUN mkdir -p /root/.android && touch /root/.android/emu-update-last-check.ini \
    && echo "no" | avdmanager create avd -n test_avd -k "system-images;android-30;default;armeabi-v7a" --device "Nexus 4"
